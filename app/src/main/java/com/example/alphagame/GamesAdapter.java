...
public class GamesAdapter extends RecyclerView.Adapter<GamesAdapter.GameViewHolder> {
    ...
    public GamesAdapter(int numberOfItems, Context parent) {
    ...
    class GameViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(int listIndex) {
            ...
            {
                case 0:
                    btnGame.setText("Больше или\nменьше");
                    break;
                case 1:
                    btnGame.setText("Выше или\nниже");
                    break;
                case 2:
                    btnGame.setText("Твердый или\nмягкий");
                    break;
                case 3:
                    btnGame.setText("Горячий или\nхолодный");
                    break;
                case 4:
