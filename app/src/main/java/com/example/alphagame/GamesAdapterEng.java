...
public class GamesAdapterEng extends RecyclerView.Adapter<GamesAdapterEng.GameViewHolder> {

    private int numberItems;
    private Context parent;

    public GamesAdapterEng(int numberOfItems, Context parent) {
